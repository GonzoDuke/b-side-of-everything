  ...
  function FnText({ n, children }) {
    return (
      <div style={{
        ...
        <span style={{ fontSize: "8px", verticalAlign: "super" }}>{n}.</span> {children}
      </div>
    )
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ color: "rgba(255,255,255,0.4)" }}>21 pages</span>
        </div>
      </div>
      ...
      <Page number={87}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          <div style={{ fontSize: "11pt", fontWeight: 700, marginBottom: "10px" }}>
      ...
      {/* PAGE 3 */}
      <Page number={89}>
        <P first>This study relies on four primary informant sources, identified here according to the protocols established by the Institutional Review Board (IRB Protocol #2019-0847, approved March 2019, amended November 2019 following difficulties with informant recruitment that are discussed below):</P>
      ...
      <Page number={94}>
        ...
        <P>Geoff W. disputes this transcription entirely, claiming the actual lyrics were "mostly improvised complaints about scheduling conflicts and cafeteria food," though he acknowledges what he terms the band's tendency toward "accidental profundity." The discrepancy is itself illustrative of a pattern that recurred throughout the fieldwork. Informants consistently disagreed not merely on details of the band's history but on the fundamental nature of what Panhandling for God was doing.</P>
      </Page>

      {/* PAGE 9 */}
      <Page number={95}>
        <P first>Was the project sincerely devotional? Ironically so? Both simultaneously, in a manner that resists the analytic distinction between sincerity and its performance? The researcher's provisional assessment, offered with the caveat that the evidence base is not sufficient to support a strong claim, is that what might tentatively be described as the ambiguity of the project's devotional stance was not incidental to its practice but may have constituted something closer to the practice itself. That is to say, Panhandling for God appears to have operated in what the researcher proposes to characterize, following Turner, as the gap between sincerity and its performance, a liminal condition in which normative structures of religious expression become visible precisely because they have been temporarily, and perhaps inadvertently, suspended.<Fn n={12} /> Whether the band's members would recognize this interpretation is, as noted above, doubtful. Geoff W., when the researcher presented a simplified version of this framework during a follow-up phone call, responded: "I think we were just trying to play in time, man."</P>
      ...
      <Page number={106}>
        ...
        <div style={{ lineHeight: "12pt" }}>
          <FnText n={1}>Turner, Victor. <em>The Ritual Process: Structure and Anti-Structure</em> (Chicago: University of Chicago Press, 1969), 94{"\u2013"}130. Turner's concept of liminality, while developed in the context of Ndembu ritual practice, has been widely applied to contemporary Western contexts, not always with sufficient care.</FnText>
          ...
          <FnText n={3}>Anonymous informant, personal communication, March 2020.</FnText>

          <FnText n={4}>Paul R., telephone interview, November 15, 2019.</FnText>

          <FnText n={5}>Molly C., in-person interview, December 7, 2019.</FnText>

          <FnText n={6}>The use of Craigslist as a research tool was approved by the IRB committee with the stipulation noted in the text.</FnText>

          <FnText n={7}>IRB Protocol #2019-0847, Amendment 1, filed November 12, 2019.</FnText>

          <FnText n={8}>Darren Sato, informal communication, February 2021.</FnText>
          ...
          <FnText n={12}>Turner, <em>The Ritual Process</em>, 95.</FnText>
        </div>
      </Page>

      {/* PAGE 21 - FOOTNOTES CONTINUED */}
      <Page number={107}>
        <div style={{ lineHeight: "12pt" }}>
          <FnText n={13}>de Certeau, Michel. <em>The Practice of Everyday Life</em>, trans. Steven Rendall (Berkeley: University of California Press, 1984), 117{"\u2013"}122.</FnText>

          <FnText n={14}>Molly C., in-person interview, December 7, 2019.</FnText>

          <FnText n={15}>Molly C., in-person interview, December 7, 2019. The researcher notes the characteristic conflation of theological and logistical explanation that recurs throughout Molly C.'s testimony.</FnText>

          <FnText n={16}>Merleau-Ponty, Maurice. <em>Phenomenology of Perception</em>, trans. Donald A. Landes (London: Routledge, 2012 [1945]), 137{"\u2013"}140.</FnText>

          <FnText n={17}>Molly C., in-person interview, December 7, 2019.</FnText>

          <FnText n={18}>Bourdieu, Pierre. <em>Outline of a Theory of Practice</em>, trans. Richard Nice (Cambridge: Cambridge University Press, 1977), 72{"\u2013"}95.</FnText>
          ...
          <FnText n={20}>Buddy Collins, telephone interview, January 8, 2020. Collins retired from campus ministry in 2018 and currently works in residential real estate.</FnText>
          ...
          <FnText n={23}>Anonymous informant, email communication, June 2020. The researcher notes that the metaphor of evaporation recurs in multiple informant accounts.</FnText>

          <FnText n={24}>de Certeau, <em>The Practice of Everyday Life</em>, 91{"\u2013"}110. The researcher notes that this chapter has relied heavily on de Certeau's theoretical apparatus, perhaps more heavily than a more diversified analytic approach would recommend.</FnText>
        </div>
      </Page>
      </div>
    </div>
