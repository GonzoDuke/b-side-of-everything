...
export default function HomePage({ navigate, mounted }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        {/* Header */}
        <header style={{
          padding: "min(12vh, 100px) 40px 48px",
          maxWidth: "960px",
          margin: "0 auto",
          opacity: mounted ? 1 : 0,
        ...
        <section style={{
          ...
          <div style={{
            ...
            {/* Right: submissions + share */}
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <SmallButton
                label="Submissions welcome"
                onClick={() => { window.location.href = "mailto:archive@thebsideofeverything.com" }}
              />
...
function PieceCard({ piece, index, mounted, navigate }) {
  ...
  return (
    <div
      onClick={() => isClickable && navigate(piece.id)}
